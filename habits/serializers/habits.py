...
from habits.validators import TimeHabitsValidator, \
    HabitsValidator, SignAssociatedNiceHabitsValidator, \
...
class HabitsSerializer(serializers.ModelSerializer):
    ...
    validators = [TimeHabitsValidator('duration_time'), HabitsValidator(),
                  SignAssociatedNiceHabitsValidator('associated_nice_habit'),
                  IntervalHabitsValidator('interval'),
